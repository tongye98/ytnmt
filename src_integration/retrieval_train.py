...
from model import build_model, Model, build_adaptor
...
class TrainManager(object):
            ...
            for epoch_no in range(self.epochs):
                ...
                for batch_data in self.train_loader:
                    ...
                    if self.clip_grad_function is not None:
                        self.clip_grad_function(parameters=self.model.adaptor.parameters())
    ...
    def train_step(self, batch_data: OurData):
        ...
        batch_loss = self.model(return_type="retrieval_adaptor", src_input_code_token=code_tokens,
...
def retrieval_train(cfg_file: str) -> None:
    """
    Main Retrieval Training function.
    """
    ...
    with codecs.open("test_dir_traen2_gnn6/all_data_stored", 'rb') as f:
    ...
    # train model
    trainer.train_and_validate(train_dataset=valid_dataset, valid_dataset=valid_dataset, vocab_info=vocab_info)

if __name__ == "__main__":
    cfg_file = "test.yaml"
    retrieval_train(cfg_file)